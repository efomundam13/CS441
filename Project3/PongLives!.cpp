/*
Name(s): Manny Fomundam and Patrick Ekeu
Date: April 9, 2024
...
void render() {
    ...
    if (!gameStarted) {
        ...
        std::string instructions = " PRESS LETTER FOR DIFFICULTY ";
        std::string easy = " (E) EASY ";
        std::string medium = " (M) MEDIUM ";
        std::string hard = " (H) HARD ";
        ...
        if (gamePaused) {
            glColor3f(1.0f, 1.0f, 1.0f);
            std::string pauseMsg = "(P) Pause/Resume";
            std::string mainMenuMsg = "(ESC) Main Menu";
            std::string resetMsg = "(R) Reset Game";
        ...
        if (scorePlayer1 >= 10 || scorePlayer2 >= 10) {
            ...
            glColor3f(1.0f, 1.0f, 1.0f);
            std::string winnerMsg = scorePlayer1 >= 10 ? "Player 1 won!" : "Player 2 won!";
            std::string difficultyMsg = "Change difficulty (E, M, H)";
            std::string resetGameMsg = "Reset Game (R)";
            std::string mainMenuReturn = "Return to Main Menu (ESC)";
